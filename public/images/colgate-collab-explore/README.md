...
## Resolution
- Minimum width: **2000px** (avoids blur on Retina / full-width layouts)
- Ideal width: **2400px+**
...
- `06-short-description.png`
- `07-short-description.png`
- `08-short-description.png`
- `09-short-description.png`
- `10-short-description.png`
- `11-short-description.png`
- `12-short-description.png`

## Paths in site data
- Folder: `/images/colgate-collab-explore/`
- Project slug: `colgate-collab-explore`
